...
const Home = () => {
  ...
  return (
    <div className=''>
      <Hero />
      <div className='max-w-[1440px] mb-10 mx-auto grid lg:grid-cols-8 gap-4 '>
          ...
          <div className=" max-w-[1440px] mx-auto  grid md:grid-cols-2 lg-grid-cols-3 xl:grid-cols-4 gap-6 mb-10">
            {data.slice(5, 13).map(post => (
            <ImageBlogCard  key={post.id} post={post}  />
          ))}
          </div>
          <div className='max-w-[1440px] mb-10 mx-auto grid lg:grid-cols-8 gap-4 '>
          <div className=' col-span-5 grid grid-cols-2 gap-4 order-2 '>
